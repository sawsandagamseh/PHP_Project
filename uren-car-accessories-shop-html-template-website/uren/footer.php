                        ...
                        <div class="col-lg-4">
                            <div class="footer-widgets_info">
                                ...
                                <div class="widget-short_desc">
                                    <p>We are a team of designers and developers that create high quality cars accesory wep page to make life more easy.
                                    </p>
                                </div>
                            ...
                            <div class="footer-widgets_area">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        ...
                                        <div class="footer-widgets">
                                            <ul>
                                                <li><a href="#cata">category</a></li>
                                                <li><a href="#new">New Arraival</a></li>
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        ...
                                        <div class="footer-widgets">
                                            <ul>
                                                ...
                                                <li><a href="shop-left-sidebar.php?CataId=1">shop</a></li>
                    ...
                    <div class="row">
                                ...
                                <div class="widgets-essential_stuff">
                                    <ul>
                                        <li class="uren-address"><span>Address:</span> 
                                            Wasfi altale cercle
                                            in
                                            Irbid 21110 , Jordan</li>
                                        <li class="uren-phone"><span>Call
                                        Us:</span> <a href="tel://+962789776587">+962789776587</a>
                                        </li>
                                        <li class="uren-email"><span>Email:</span> <a href="mailto://info@uren.com">info@uren.com</a></li>
                                    </ul>
                                </div>
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="uren-social_link">
                                    <ul>
                                        <li class="facebook">
                                            <a href="https://yo.orange.jo/ar/akadymyt-orange-llbrmjt" data-toggle="tooltip" target="_blank" title="Facebook">
                                                <i class="fab fa-facebook"></i>
                                            </a>
                                        </li>
                                        <li class="twitter">
                                            <a href="https://yo.orange.jo/ar/akadymyt-orange-llbrmjt" data-toggle="tooltip" target="_blank" title="Twitter">
                                                <i class="fab fa-twitter-square"></i>
                                            </a>
                                        </li>
                                        <li class="google-plus">
                                            <a href="https://yo.orange.jo/ar/akadymyt-orange-llbrmjt" data-toggle="tooltip" target="_blank" title="Google Plus">
                                                <i class="fab fa-google-plus"></i>
                                            </a>
                                        </li>
                                        <li class="instagram">
                                            <a href="https://yo.orange.jo/ar/akadymyt-orange-llbrmjt" data-toggle="tooltip" target="_blank" title="Instagram">
                                ...
                                <div class="sp-content">
                                    ...
                                    <div class="sp-essential_stuff">
                                        <ul>
                                            ...
                                            <li>EX Tax: <a href="javascript:void(0)"><span>$373.37</span></a></li>
                                            <li>Price in reward points: <a href="javascript:void(0)">370</a></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="uren-social_link">
                                        <ul>
                                            ...
                                            <li class="youtube">
                                                <a href="https://yo.orange.jo/ar/akadymyt-orange-llbrmjt" data-toggle="tooltip" target="_blank" title="Youtube">
