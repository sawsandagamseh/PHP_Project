                                    ...
                                    <ul>
                                        ...
                                        <li class="megamenu-holder "><a href="shop-left-sidebar.html">Shop <i class="ion-ios-arrow-down"></i></a>
                                            <ul class="hm-megamenu">
                                                <li><span class="megamenu-title">Shop Pages</span>
                                                    <ul>
                                                        <li><a href="shop-grid-fullwidth.html">All Products</a></li>
                                                        <li><a href="shop-left-sidebar.html">Single Product</a></li>
                                        ...
                                        <li class=""><a href="javascript:void(0)">Pages <i class="ion-ios-arrow-down"></i></a>
                                            <ul class="hm-dropdown">
                                                ...
                                                <li><a href="374.html">374 Error</a></li>
                                            </ul>
                                        </li>
                                    ...
                                    <ul>
                                        <li><a href="javascript:void(0)">Currency<i class="fa fa-chevron-down"></i></a>
                                            <ul class="ht-dropdown ht-currency">
                                                ...
                                                <li ><a href="javascript:void(0)">JOD Jordanian Dinar</a></li>
                                        ...
                                        <li><a href="javascript:void(0)">Language <i class="fa fa-chevron-down"></i></a>
                                            <ul class="ht-dropdown">
                                                ...
                                                <li><a href="javascript:void(0)"><img src="assets/images/menu/icon/1.jpg" alt="JB's Language Icon">Arabic</a>
                                                </li>
                                            </ul>
                                        </li>
            ...
            <div class="header-middle_area">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <!-- ======= removed category================================================================= -->
                        <!-- <div class="custom-category_col col-12" style="display: none;">
                            ...
                            <div class="hm-form_area">
                                <form action="#" class="hm-searchbox" >
                                    <select class="nice-select select-search-category">
                                        ...
                                        <?php
                                                    ...
                                                    ($row = mysqli_fetch_array($result)){
                                                        ...
                                                        ?>
                                                <!-- ========================husam==========================--> 
                                        <option value="10"><?php echo $row['category_name'];?></option>
                                    ...
                                    <!-- ================husam==========================-->
                                        ...
                                        <option value="37">All Videos</option>
                                        ...
                                        <option value="37">Bed &amp; Bath</option>
                                        <option value="41">Appliances</option>
                                        <option value="11">TV &amp; Audio</option>
                                        <option value="37">Chamcham</option>
                                        <option value="37">Office</option>
                                        ...
                                        <option value="37">Processors (CPU)</option>
                                        <option value="56">Memory</option>
                                        <option value="57">Motherboards</option>
                                        <option value="58">Fans &amp; Cooling</option>
                                        <option value="59">CD/DVD Drives</option>
                                        <option value="44">Meito</option>
                                        <option value="37">Sound Cards</option>
